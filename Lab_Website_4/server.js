...
app.get('/home/pick_color', function(req, res) {
	...
	var color_options = 'SELECT * FROM favorite_colors;';// EDIT HERE Write a SQL query to retrieve the colors from the database
	var color_message = "SELECT color_msg FROM favorite_colors where hex_value ='" + color_choice + "';";// EDIT HERE Write a SQL query to retrieve the color message for the selected color
